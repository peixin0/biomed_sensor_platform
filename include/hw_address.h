 ...
 * @date    2026-03-05
 * @file    hw_addresses.h
 * @brief   Physical memory map and hardware abstraction definitions for DE1-SoC.
 * @discaimer This file is  based on Leeds DE1-SoC documentation 

 */

#ifndef HW_ADDRESSES_H
#define HW_ADDRESSES_H
